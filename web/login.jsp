...
<BODY>
<FORM id=form1 name=form1 action="${pageContext.request.contextPath }/loginAction_login" method=post>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <td><font color="red" id="errMsg"><s:property value="msg"/></font></td>
              </TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR>
  <TR>
    <TD><IMG src="images/login_3.jpg" 
border=0></TD></TR></TBODY></TABLE></DIV></DIV>2
